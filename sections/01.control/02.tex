\chapter{Tracking the circumference of a circle with a RC car}
...
\begin{itemize}
  \item Notions/resources/tools used: Predictive Control, \texttt{ROS},  Linux, \texttt{Python}, \texttt{git}, \texttt{MATLAB}, MoCap
\end{itemize}
