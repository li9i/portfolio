\chapter{CultureID: Internet of Things, Robotics, Big Data, AI in Culture (T2EDK-02000)}
...
Thessaloniki (AMTh), Greece. Specifically, in partnership with the project's
partners and our team's members, I thought, designed, implemented, deployed,
tested, and refined the systems concerning the two activities that the robot
was tasked to hold in the museum: (a) playing games while acting as the game
master with students whose school pays visit to the museum, and (b) acting as a
tour guide for specific displayed artefacts.
...
\begin{itemize}
  \item Notions/resources/tools used: \texttt{ROS} (kinetic), Linux (Ubuntu 16.04 LTS), Hokuyo LIDAR (UST-10LX), RPLIDAR A3 (panoramic), 2D/3D SLAM, Depth ASTRA Cameras, localisation particle filter \texttt{amcl}, ROS autonomous navigation stack, \texttt{git}, RFID Reader Impinj R420
