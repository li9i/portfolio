...
The project developed a social robot, Indy!, with the
...
Archaeological Museum of Thessaloniki (AMTh), Greece. Specifically, in
partnership with the project's partners and our team's members, I thought,
designed, implemented, deployed, tested, and refined the systems concerning the
two activities that the robot was tasked to hold in the museum: (a) playing
games while acting as the game master with students whose school pays visit to
the museum, and (b) acting as a tour guide for specific displayed artefacts.
