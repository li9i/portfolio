\chapter[CULTUREID: A robot in a museum]{CultureID: Internet of Things, Robotics, Big Data, AI in Culture (T2EDK-02000)}
...
\begin{itemize}\small
  ...
  \item 2020/09--2023/09 \vspace{-1em}
  \item \href{https://cultureid.web.auth.gr/?page_id=216&lang=en}{\texttt{[website]}} \href{https://www.facebook.com/cultureID.Auth}{\texttt{[fb]}} \href{https://www.youtube.com/@cultureidproject}{\texttt{[videos]}} \href{https://cultureid.web.auth.gr/?page_id=490}{\texttt{[publications]}} \href{https://github.com/cultureid-auth-ros-packages}{\texttt{[public code]}} \href{https://www.lifo.gr/now/tech-science/arhaiologiko-moyseio-thessalonikis-ena-rompot-tha-syzita-me-toys-episkeptes}{\texttt{[press]}}
\end{itemize}

\begin{figure}[H]\centering
  \includegraphics[scale=0.2]{images/cultureid/indy_at_museum.jpg}
  \caption{\small CultureID's robot acting as a game master with pupils of the
           4th public elementary school of Thessaloniki while on visit to the
           city's Archaeological Museum. The games' purpose is at the same time
           educational and entertaining. The robot requires from pupils to
           answer its questions, which they do by scouring the nearby exhibits
           for clues. A game consists of sets played at different museum sections,
           with the robot moving autonomously from one to the other among the
           pupils, while maintaining set distances from them and the museum's
           exhibits}
  \label{fig:cultureid_indy}
\end{figure}

The project developed a social robot, Indy, with the explicit intent of
bridging cultural facts, artefacts, works of art, and general knowledge---over
to the audience of a museum: in particular that of the Archaeological Museum of
Thessaloniki (AMTh), Greece.

\section{My contribution}

In partnership with the project's members and our team at the Aristotle
University of Thessaloniki, I thought, designed, implemented, deployed, tested,
configured, and refined the systems concerning the two activities that the
robot was tasked to hold in the museum: (a) playing games while acting as the
game master with students whose school pays visit to the museum, and (b) acting
as a tour guide for some of the museum's select artefacts. This project built
on top of the experience gained from earlier project RELIEF, exploited its
already existing knowledge and research capital while incorporating new
elements, such as microphones, voice recognition, integration of
speech-to-text, text-understanding and processing, and text-to-speech state of
the art algorithms before the advent of ChatGPT.
...
in one region of the museum, but it was designed to be extensible,
...
of the Museum's archaeologists. Then \texttt{rasa} was built around these
scenarios. The text-to-speech and speech-to-text was handled by Google. Sound
was captured via a panoramic microphone array, which was specifically chosen
...
\begin{itemize}
  \item Notions/resources/tools used: \texttt{ROS} (kinetic), \texttt{Linux} (Ubuntu 16.04 LTS), Hokuyo LIDAR (UST-10LX), RPLIDAR A3 (panoramic), 2D SLAM (\texttt{openkarto}), Depth ASTRA Cameras, particle filter for localisation \texttt{amcl}, ROS autonomous navigation stack, \texttt{git}, RFID Reader Impinj R420
\item Publications authored or coauthored as a direct or indirect result of this project: \cite{8739423,8739486,Filotheou2020a,9109328,9244904,Filotheou2020b,9566425,9617436}
\end{itemize}
