\chapter{RELIEF: Intelligent Repeaters and Robots for Fast, Reliable, Low-Cost RFID Inventorying \& Localization (T1EDK-03032)}
...
filters, pose tracking, global localisation, LIDAR odometry, pose estimate
error reduction). At the same time I was the sole developer/maintainer/handler
for everything related with the robots especially when seen from the SW
perspective: integrating, configuring, and testing SLAM algorithms (progressive
mapping and simultaneous self-localisation), localisation after SLAM,
autonomous navigation; creating GUIs for simplified task execution by
third-parties; assisting PhD students to conduct their experiments with robots
using special RFID equipment; integrating RFID-related algorithms onto the
robot and then in tandem with the robot's packages.
