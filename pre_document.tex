...
\usepackage{listings}
\usepackage{color}
%\usepackage[linkbordercolor=magenta,unicode]{hyperref}
...
% Remove "Chapter N" from chapter beginning
\makeatletter
...
\makeatother
%
%\usepackage{titlesec}[nostruts]
%\titleformat{\chapter}[display]{\huge}{}{1ex}{}{}
%\titlespacing{\chapter}{0pt}{0pt}{0pt}

\usepackage{etoolbox}
\makeatletter
\patchcmd{\@makechapterhead}{\vspace*{50\p@}}{\vspace*{-70\p@}}{}{}
\makeatother

% mini toc / toc per chapter etc
\usepackage{minitoc}
\dominitoc
